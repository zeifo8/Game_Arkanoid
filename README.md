Выполнил: Некрасов Леонид,  5030102/30003
...
Выбрал 1-6 + 7, также если мяч попадает мимо каретки то увеличивается число поражений (то есть уменьшается количество жизней).

Игру писал на C++ с использованием SFML 3.0.
Собрать проект можно через CMake.
